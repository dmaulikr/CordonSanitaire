...
//        return CGPathContainsPoint(polygonView.path, nil, polygonViewPoint, NO)
    ...
    private func getNextPlayerCounterClockwise (id: String) -> String {
        ...
        var start_theta = atan2((player!.latitude - center.latitude),(player!.longitude - center.longitude))
        ...
        for other_player in quarantinePlayers.values.array {
            ...
            if (other_player.id != player!.id){
                ...
                var next_theta = atan2((other_player.latitude - center.latitude),(other_player.longitude - center.longitude))
                println("next theta: " + next_theta.description)
